...
class ReactjsApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        ReactjsApplicationKafkaResource kafkaResource = new ReactjsApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/reactjs-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/reactjs-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
