...
@RestController
@RequestMapping("/api/reactjs-application-kafka")
public class ReactjsApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReactjsApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ReactjsApplicationKafkaResource(KafkaProperties kafkaProperties) {
