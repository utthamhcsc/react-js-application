          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('psize')}>
                  <Translate contentKey="storeApp.product.psize">Psize</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`storeApp.Size.${product.psize}`} />
                  </td>
                  <td>
                    {product.image ? (
                      <div>
