...
class ProductResourceIT {
    ...
    private static final Size DEFAULT_PSIZE = Size.S;
    private static final Size UPDATED_PSIZE = Size.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPsize()).isEqualTo(DEFAULT_PSIZE);
    ...
    @Test
    void checkPsizeIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().collectList().block().size();
        // set the field null
        product.setPsize(null);
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].psize")
            .value(hasItem(DEFAULT_PSIZE.toString()))
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.psize")
            .value(is(DEFAULT_PSIZE.toString()))
            .jsonPath("$.imageContentType")
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getPsize()).isEqualTo(UPDATED_PSIZE);
