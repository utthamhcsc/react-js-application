...
export class ProductUpdatePage {
  ...
  psizeSelect = element(by.id('field_psize'));
  ...
  async setPsizeSelect(psize: string): Promise<void> {
    await this.psizeSelect.sendKeys(psize);
  }

  async getPsizeSelect(): Promise<string> {
    return await this.psizeSelect.element(by.css('option:checked')).getText();
  }

  async psizeSelectLastOption(): Promise<void> {
